...
class BackNForthSqEuclideanSolver(BaseSolver):
    ...
    def solve(
        ...
        # was monge_map = grad_psi
        monge_map = X - grad_psi
    ...
    def _extra_metrics(
        ...
        *,
        ...
        ma_L2 = jnp.linalg.norm(ma_residual.ravel())
        # mu_mass = jnp.sum(mu_nd) * dV
        mu_mass = jnp.sum(mu_nd)
